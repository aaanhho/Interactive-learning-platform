...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
          ...
          <div class="col-xs-12">
            <div class="box">
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-4">
                  <label for="">Condition to search</label>
                  <select name="conditions[]" id="select-state-condition" class="form-control" style="width: 100%; margin-top: 0px;">
                    <option selected class="isblue" value=1>100% on first attempt</option>
                    <option class="isblue" value=2>Less than 50% on second attempt</option>
                  </select><br>
                  <script>
    ...
    $('.btn-search').click(function(){
      var condition = $('select[name="conditions[]"]').val();
      window.location.href = `search_attempt_by_score.php?condition=${condition}`; 
    });
    </script>
</body>
